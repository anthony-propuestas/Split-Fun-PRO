...
| Recurso   | Binding     | Uso |
|----------|-------------|-----|
| D1       | `env.DB`    | Todas las operaciones SQL (perfiles, grupos, gastos, splits, settlements, logros, recordatorios). |
| R2       | `env.R2_BUCKET` | Almacenamiento de objetos (no inventariado en detalle aquí). |
